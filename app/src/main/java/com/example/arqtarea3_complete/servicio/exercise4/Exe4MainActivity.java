package com.example.arqtarea3_complete.servicio.exercise4;
...
public class Exe4MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.service_exe4_activity_main);
    ...
    protected void onStart() {
        ...
        IntentFilter filter = new IntentFilter(Sha1HashBroadcastService.SHA1_BROADCAST);
