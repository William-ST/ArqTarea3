...
public class PrimeNumberAsyntaskActivity extends AppCompatActivity {
    ...
    public void triggerPrimecheck(View v) {
        Log.v(TAG, "Thread " + Thread.currentThread().getId() + ": Comienza triggerPrimecheck()");
        long parameter = Long.parseLong(inputField.getText().toString());
        mAsyncTask = new MyAsyncTask();
        mAsyncTask.execute(parameter);
        Log.v(TAG, "Thread " + Thread.currentThread().getId() + ": Finaliza triggerPrimecheck()");
    }
