...
public class IntervalSearchPrimeNumberActivity extends AppCompatActivity implements FragmentOculto.TaskListener, App.StatusAppInterface {

    private static final String TAG = IntervalSearchPrimeNumberActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            primecheckbutton.setText(savedData.getPrimecheckbuttonText());
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(KEY_SALVE_DATA, new SavedData(resultAdapter.getResultList(), primecheckbutton.getText().toString()));
        /*
    ...
    public void onPostExecute() {
        primecheckbutton.setText("Buscar primos");
